...
// Encode the String
export const encodeBase64 = encodedString => Base64.encode(encodedString);

export const decodeBase64 = decodedString => Base64.decode(decodedString);

export const SERVER_API_URL = 'https://api.tinvang.com.vn';
export const SERVER_IMAGE_URL = 'https://api.tinvang.com.vn';
export const SERVER_URL = 'https://tinvang.com.vn';
...
export const queryString = parameters => queryStringUtils.stringify(parameters);
/*
  // eslint-disable-next-line
  let queryString = '';
  // eslint-disable-next-line
